...
async(req ,res)=>{
 ...
 //   try {
    ...
    if(user){
        return res.status(200).json("Please enter correct password")
    };
    ...
    res.status(200).json({status:"Pending",msg:"Check your mail", user:user._id})
...
router.post("/verify/email",async (req , res)=>{
    ...
    const transport = nodemailer.createTransport({
      ...
      transport.sendMail({
        ...
        html:`Now you can login and socialize`
      })
