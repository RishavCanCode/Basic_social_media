...
export default function Signup() {
  ...
  console.log(user?.user?.Status ?? "Status not available");
  const handleClick = (e)=>{
    e.preventDefault();
  ...
  return (
    <div className='mainContainerForsignup'>
        ...
        <input type="file" name="file" id="file" onChange={(e)=>setfile(e.target.files[0])} />
          ...
          <input type="email" name="" id="emailInput" placeholder='email' onChange={(e)=>setEmail(e.target.value)} className='inputText' />
