  ...
  return (
    <div className='Leftbar'>
        <div className='NotificationsContainer'>
                ...
                <h3>Notifications</h3>
                <p style={{ color: "white" , marginLeft:"40px" }}>See all</p>
                </div>
                <div style={{display:'flex' , alignItems:"center" , marginTop:-10}}>
                                                  <img src={`${image}`} className="notificationimg" alt="" />
                                                  <p style={{marginLeft:"5px" , color:"white" , fontSize:13 , width:"120px" , textAlign:"start"}}>Rishu like your post</p>
                                                  <img src={`${image1}`} className="likeimage" alt="" />
                </div>
                <div style={{display:'flex' , alignItems:"center" , marginTop:-10}}>
                                                  <img src={`${image}`} className="notificationimg" alt="" />
                                                  <p style={{marginLeft:"5px" , color:"white" , fontSize:13 , textAlign:"start" , width:"120px"}}>Rishav started to following you</p>
                                        ...
                                        <div style={{display:'flex' , alignItems:"center" , marginTop:-10}}>
                                                  <img src={`${image}`} className="notificationimg" alt="" />
                                                  <p style={{marginLeft:"5px" , color:"white" , fontSize:13 ,  width:"120px" , textAlign:"start"}}>Rishav started to following you</p>
